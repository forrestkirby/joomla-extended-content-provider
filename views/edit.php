...
<div class="uk-form uk-form-horizontal" ng-class="vm.name == 'contentCtrl' ? 'uk-width-large-2-3 wk-width-xlarge-1-2' : ''">
    ...
    <div class="uk-form-row">
        <label class="uk-form-label" for="wk-offset">{{'Offset' | trans}}</label>
        <div class="uk-form-controls">
            <input id="wk-offset" class="uk-form-width-large" type="number" value="0" min="0" step="1" ng-model="content.data['offset']">
        </div>
    </div>
